  ...
  <section class="food_section layout_padding">
    <div class="container">
     ...
     <ul class="filters_menu">
        ...
        <li data-filter=".burger">Accion</li>
        <li data-filter=".pizza">Drama</li>
        <li data-filter=".pasta">Comedia</li>
        <li data-filter=".fries">Terror</li>
      </ul>
        ...
        <div class="row grid">
          ...
          <div class="col-sm-6 col-lg-4 all burger">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="images/john-wick-615155l.jpg" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    John Wick
                  ...
                  <p>
                   John Wick, un exasesino a sueldo, se enfrenta al mafioso Viggo Tarazov, quien ofrece una recompensa a aquel que logre acabar con la vida de Wick.
                  </p>
                  <div class="options">
                    <h6>
                      $145
          ...
          <div class="col-sm-6 col-lg-4 all pizza">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="images/yoantesdeti.jpg" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Yo antes de ti
          ...
          <div class="col-sm-6 col-lg-4 all fries">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="images/blackphone.jpg" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Black Phone
          ...
          <div class="col-sm-6 col-lg-4 all pizza">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="images/adosmetrosdeti.jpg" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    A dos metros de ti
          ...
          <div class="col-sm-6 col-lg-4 all burger">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="images/civilwar.jpg" alt="">
                </div>
                <div class="detail-box">
                  <h5>
          ...
          <div class="col-sm-6 col-lg-4 all pasta">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="images/esposamentira.jpg" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                  ...
                  <p>
                   El cirujano Danny decide contratar a su ayudante Katherine, una madre soltera con hijos, para que finjan ser su familia. Su intención es demostrarle a Palmer que su amor por ella es tan grande que está a punto de divorciarse de su mujer.
                  </p>
                  <div class="options">
                    <h6>
                      $100
            ...
            <div class="box">
              <div>
                ...
                <div class="detail-box">
                  ...
                  <div class="options">
                    <h6>
                       <h6 style="margin-right: 200px;">$<?php echo $renglon[3];?></h6>
                    </h6>
                    <a href="">
                      <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 456.029 456.029" style="enable-background:new 0 0 456.029 456.029;" xml:space="preserve">
                        <g>
